...
export default function ProductDetail() {
    ...
    useEffect(() => {
        ...
        const fetchProductDetail = async () => {
            try {
                const fetchedProduct = await fetch(`https://e-commerce-frontend-yinf.onrender.com/api/v1/product/${product_id}`)
    ...
    const addReview = async (e) => {
        ...
        if (reviewState === "") {
            try {
                ...
                const addedReview = await fetch('https://e-commerce-frontend-yinf.onrender.com/api/v1/product/reviews', {
                    method: 'PUT',
                    headers: {
